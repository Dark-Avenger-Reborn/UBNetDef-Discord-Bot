jokes = [
    ...
    "Why did the Red Team bring a ladder? To escalate their privileges.",
    "What’s the Blue Team’s favorite song? 'Don’t Stop Encryptin’.'",
    "Why do hackers love fishing? Because they’re experts at phishing.",
    "What’s the Red Team’s favorite weather? Storms with a chance of exploits.",
    "Why don’t firewalls play hide-and-seek? They’re too transparent.",
    "What’s the Blue Team’s favorite exercise? Firewall lunges.",
    "Why did the hacker buy a calendar? To schedule their attacks.",
    "Why did the server go on a diet? To reduce its load.",
    "What’s a hacker’s favorite type of music? Heavy payload metal.",
    "Why don’t injects go hiking? They’re afraid of getting patched up.",
    "What’s the Blue Team’s favorite type of pie? Privilege pie.",
    "Why did the router go to therapy? It had too many unresolved connections.",
    "What’s a hacker’s favorite game? Capture the Flag.",
    "Why did the Blue Team bring a flashlight? To shine a light on hidden vulnerabilities.",
    "What’s the Red Team’s favorite sport? Hacking hurdles.",
    "Why did the firewall feel lonely? It was left out of the chain.",
    "What do hackers eat for lunch? Exploited sandwiches.",
    "Why did the server fail its math test? It couldn’t handle integers.",
    "What’s a hacker’s favorite social media platform? LinkedIn—for lateral movement.",
    "Why did the Blue Team carry a whistle? To alert others to breaches.",
    "What’s the Red Team’s favorite drink? Root beer.",
    "Why don’t firewalls like gossip? They block unnecessary traffic.",
    "Why did the hacker start a delivery business? They specialize in payloads.",
    "What’s the Blue Team’s favorite mode of transportation? Secure sockets.",
    "Why did the server host a party? It wanted to boost its connections.",
    "What’s a hacker’s favorite type of sandwich? Open-faced vulnerabilities.",
    "Why don’t injects play poker? They can’t handle bluffing protocols.",
    "What’s the Blue Team’s favorite breakfast? Patch pancakes.",
    "Why did the hacker take up knitting? To create loops and threads.",
    "What’s the Red Team’s favorite vacation spot? Trojan Islands.",
    "Why did the server start lifting weights? To handle heavier traffic.",
    "What’s the Blue Team’s least favorite insect? The bug.",
    "Why did the hacker become a gardener? They’re experts in rootkits.",
    "What’s the Blue Team’s favorite movie? *The Silence of the Logs*.",
    "Why did the router go to art school? To learn how to draw connections.",
    "What’s the Red Team’s favorite musical? *Phantom of the Packet.*",
    "Why do injects never relax? They’re always on high alert.",
    "What’s the Blue Team’s favorite animal? The watchdog.",
    "Why did the hacker join a band? To exploit the strings.",
    "What’s the Red Team’s favorite dance move? The Payload Shuffle.",
    "Why don’t servers go skydiving? They’re afraid of dropping packets.",
    "What’s a hacker’s favorite flower? The data daisy chain.",
    "Why did the Blue Team buy a coffee maker? To keep up with Java attacks.",
    "What’s the Red Team’s favorite book? *How to Win Friends and Exploit People.*",
    "Why don’t injects like parties? They hate getting filtered out.",
    "What’s the Blue Team’s favorite color? Secure Green.",
    "Why did the hacker bring a pencil? To draft their scripts.",
    "What’s the Red Team’s favorite type of literature? Exploitation manuals.",
    "Why don’t firewalls like jokes? They don’t appreciate bypass humor.",
    "What’s a hacker’s favorite dessert? Exploit éclairs.",
    "Why did the server break up with the router? It couldn’t handle the connection.",
    "What’s the Blue Team’s favorite tool? A magnifying glass for fine-tuning logs.",
    "Why did the hacker go to comedy school? To master delivery payloads.",
    "What’s the Blue Team’s favorite plant? The honeypot cactus.",
    "Why did the firewall go camping? To practice blocking unauthorized tents.",
    "What’s a hacker’s favorite fruit? Pwn-apples.",
    "Why did the server apply for a job? It wanted better bandwidth.",
    "What’s the Blue Team’s favorite type of architecture? Zero-trust designs.",
    "Why did the hacker join a book club? To read between the lines of code.",
    "What’s the Red Team’s favorite game console? The Xploit Box.",
    "Why don’t injects take shortcuts? They prefer the longer stack trace.",
    "Why do hackers prefer coffee over tea? Because they love Java.",
    "What’s the Blue Team’s favorite ice cream flavor? Patch-a-chip.",
    "Why did the Red Team go to space? To test for vulnerabilities in the cloud.",
    "What’s the Blue Team’s favorite superhero? Captain Encrypt.",
    "Why did the server wear sunglasses? It was handling too much bright data.",
    "What’s a hacker’s favorite dessert? Malware-mellow pie.",
    "Why did the firewall go to the gym? To strengthen its defenses.",
    "What’s the Red Team’s favorite fairy tale? *Goldilocks and the Three Exploits.*",
    "Why don’t injects like stand-up comedy? They hate being called out.",
    "What’s the Blue Team’s favorite snack? Secured cookies.",
    "Why did the hacker become a chef? To specialize in buffer overflows.",
    "What’s the Red Team’s favorite game? *Steal or No Steal.*",
    "Why did the Blue Team become photographers? To capture every suspicious moment.",
    "What’s a hacker’s favorite type of car? A Trojan Mustang.",
    "Why did the server fail at school? It didn’t have enough bandwidth for homework.",
    "What’s the Red Team’s favorite movie? *The Exploitables.*",
    "Why did the firewall become a poet? To write block-worthy lines.",
    "What’s the Blue Team’s favorite sport? Log rolling.",
    "Why did the hacker bring a map? To navigate through the network.",
    "What’s the Red Team’s favorite mode of transport? The Trojan horse.",
    "Why don’t servers play musical chairs? They don’t like losing their seats.",
    "What’s the Blue Team’s favorite drink? Secure-tea.",
    "Why did the router throw a party? To boost its connections.",
    "What’s a hacker’s favorite type of pants? Exploit cargo pants.",
    "Why don’t injects use calendars? They’re always living in the now.",
    "What’s the Red Team’s favorite vacation activity? Phishing by the lake.",
    "Why did the firewall start meditating? To block out the noise.",
    "What’s the Blue Team’s favorite book? *Log, Actually.*",
    "Why did the hacker join the circus? To master the tightrope of exploits.",
    "What’s a server’s favorite type of exercise? Load balancing.",
    "Why don’t injects play chess? They don’t like being pawned.",
    "What’s the Blue Team’s favorite bird? The secure eagle.",
    "Why did the hacker start a bakery? They’re great at rolling out dough (exploits).",
    "What’s the Red Team’s favorite hobby? Cracking open cold encryptions.",
    "Why did the server take a vacation? It needed to cool off from all the traffic.",
    "What’s the Blue Team’s favorite instrument? The bugle (to sound the alarm).",
    "Why did the firewall bring a snorkel? To filter out deep packets.",
    "What’s a hacker’s favorite type of party? A code-breaker bash.",
    "Why did the router get promoted? It always had the best connections.",
    "What’s the Red Team’s favorite math subject? Algebraic exploits.",
    "Why don’t injects like roller coasters? They hate being flagged.",
    "What’s the Blue Team’s favorite dance move? The Patch Step.",
    "Why did the hacker go to the library? To check out a book on exploits.",
    "What’s the server’s favorite type of music? High-bandwidth beats.",
    "Why did the firewall go to school? To learn about segmentation.",
    "What’s the Blue Team’s favorite soup? Logs-ter bisque.",
    "Why did the hacker bring a boomerang? To test for reverse shells.",
    "What’s the Red Team’s favorite board game? *Hackgammon.*",
    "Why don’t injects go to the movies? They can’t handle blockbusters.",
    "What’s the Blue Team’s favorite holiday? Patch Tuesday.",
    "Why did the router buy a diary? To log all its connections.",
    "What’s a hacker’s favorite vegetable? The root vegetable.",
    "Why did the firewall take singing lessons? To improve its voice protocols.",
    "What’s the Red Team’s favorite dessert? Buffer overflow cake.",
    "Why don’t servers play the lottery? They don’t like random chances.",
    "What’s the Blue Team’s favorite exercise equipment? The thread mill.",
    "Why did the hacker start a delivery service? To specialize in payload drops.",
    "What’s the Red Team’s favorite comedy? *Exploits of the Week.*",
    "Why don’t injects like hiking? They’re afraid of getting filtered out.",
    "What’s the Blue Team’s favorite type of tree? The honeypot tree.",
    "Why did the server go vegan? It couldn’t handle spam.",
    "What’s a hacker’s favorite holiday? Exploitmas.",
    "Why did the hacker wear glasses? To improve their site vision.",
    "What’s the Red Team’s favorite fruit? Phish sticks.",
    "Why did the server become an artist? It loved creating abstract models.",
    "What’s the Blue Team’s favorite game? Capture the Packet.",
    "Why did the hacker sit under a tree? To look for root access.",
    "What’s a server’s favorite movie? *Load of the Rings.*",
    "Why did the firewall get a promotion? It was outstanding in its field.",
    "What’s the Red Team’s favorite type of candy? Exploit mints.",
    "Why don’t injects like beaches? Too many sandboxes.",
    "What’s the Blue Team’s favorite dance? The Update Shuffle.",
    "Why did the router break up with the modem? It lost the connection.",
    "What’s a hacker’s favorite pet? A phishing cat.",
    "Why did the server take up yoga? To improve its uptime flexibility.",
    "What’s the Red Team’s favorite sport? Password cracking.",
    "Why don’t injects like cooking? They hate being salted.",
    "What’s the Blue Team’s favorite flower? The Secure Orchid.",
    "Why did the hacker join the theater? To perform exploits on stage.",
    "What’s a server’s favorite type of coffee? JavaScript brew.",
    "Why did the router become a DJ? It was great at spinning connections.",
    "What’s the Red Team’s favorite drink? Spy-sy cider.",
    "Why don’t injects play card games? They’re afraid of getting dealt.",
    "What’s the Blue Team’s favorite dessert? Secure pudding.",
    "Why did the server join a band? To jam with packets.",
    "What’s a hacker’s favorite constellation? The Exploit Belt.",
    "Why did the firewall go on vacation? To decompress.",
    "What’s the Blue Team’s favorite sport? Patching relay races.",
    "Why don’t injects like zip lines? They can’t handle compressed payloads.",
    "What’s the Red Team’s favorite fish? The bass-ion.",
    "Why did the server go to therapy? It had too much load on its mind.",
    "What’s the Blue Team’s favorite snack? Log crackers.",
    "Why did the router take a nap? It was out of sync.",
    "What’s a hacker’s favorite programming language? Exploitronix (fictional but funny).",
    "Why did the server visit the beach? To enjoy some packet sand.",
    "What’s the Blue Team’s favorite exercise? Firewall planks.",
    "Why did the hacker cross the road? To access the other subnet.",
    "What’s the Red Team’s favorite fruit? An apple with a worm.",
    "Why did the firewall go to the gym? To build up its block strength.",
    "What’s the server’s favorite game? Hide and seek IPs.",
    "Why don’t injects like weddings? They hate being sanitized.",
    "What’s the Blue Team’s favorite music genre? Log and roll.",
    "Why did the router apply for a patent? It had a novel protocol.",
    "What’s the Red Team’s favorite vacation spot? The Exploit Islands.",
    "Why did the server love winter? Fewer bugs in the system.",
    "What’s the Blue Team’s favorite type of weather? Encrypted storms.",
    "Why don’t injects go to school? They fail validation tests.",
    "What’s the Red Team’s favorite dance move? The Exploit Slide.",
    "Why did the server host a party? It needed to network.",
    "What’s a hacker’s favorite room? The backdoor pantry.",
    "Why did the firewall become a farmer? To grow block crops.",
    "What’s the Blue Team’s favorite song? *You Raise Me Logs.*",
    "Why don’t injects like sports? Too many filters on the field.",
    "What’s the server’s favorite bedtime story? *The Packet Prince.*",
    "Why did the hacker learn magic? To master disappearing payloads.",
    "What’s the Red Team’s favorite instrument? The attack piano.",
    "Why did the router get a haircut? To remove unnecessary layers.",
    "What’s the Blue Team’s favorite game? Honeypot hide-and-seek.",
    "Why did the server fail its driving test? It couldn’t handle traffic.",
    "What’s a hacker’s favorite sandwich? A payload panini.",
    "Why did the firewall write poetry? To rhyme and reason.",
    "What’s the Red Team’s favorite weather? A perfect storm of vulnerabilities.",
    "Why did the server join a dating app? It wanted a better connection.",
]